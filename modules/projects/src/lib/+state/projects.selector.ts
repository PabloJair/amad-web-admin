...
import { companiesAdapter, PROJECT_FEATURE_KEY, projectAdapter } from './projects.reducer';

const projectAppState = createFeatureSelector<ProjectAppState>(PROJECT_FEATURE_KEY);
...
const companies = createSelector(companiesState, companyAdapterSelector.selectAll);
