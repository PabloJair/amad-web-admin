...
import {
  ...
  FileUploadComponent,
  FileUploadControl, FileUploadDropZoneComponent, FileUploadListItemComponent,
...
export class ProjectAddComponent {
  ...
  public readonly fileUploadControl = new FileUploadControl(
    { listVisible: true, accept: [CommonsStrings.MIME_TYPE_PNG,CommonsStrings.MIME_TYPE_JPG], discardInvalid: true, multiple: false },
  ...
  constructor(public  navigation:ProjectNavigationService,
    ...
    this.add$$ = this.projectFacade.successAddCompany.subscribe(value => {
  ...
  add() {
    ...
    const request:AddOrEditProjectRequest = {
      ...
      status:this.addCompanyForm.controls.status.value ? ProjectStatus.ACTIVE : ProjectStatus.DISABLE,
