export const environment = {
  ...
  production: true,
  TOKEN_IV_SECRET_PHRASE:process.env["NG_APP_TOKEN_IV_SECRET_PHRASE_PRD"] ??"" ,
  ...
  URL_DOWNLOAD_DOCUMENT_HISTORICAL:process.env["NG_APP_URL_HISTORICAL_DOCUMENTS_KEY_PRD"] ??""
};
